...
class MapTRGCN(MVXTwoStageDetector):
    """MapTR.
    Args:
    ...
    def simple_test_pts(self, x, lidar_feat, img_metas, prev_bev=None, rescale=False):
        ...
        manifold_outs = self.manifold_head(outs)

        bbox_list = self.manifold_head.get_bboxes(
            manifold_outs, img_metas, rescale=rescale)
        ...
        # import pdb;pdb.set_trace()
        return manifold_outs['bev_embed'], bbox_results
