...
class MapTRAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        # print('gts num: ', gt_bboxes.shape, 'pred nums: ', bbox_pred.shape, 'gt_labels: ', gt_labels.shape)
        ...
        # print('normalized_gt_pts: ', normalized_gt_pts.shape)#18*19*29*2
        # assert False
        ...
        # cos_cost_ordered = self.cos_cost(pts_pred_interpolated, normalized_gt_pts)
        # pts_cost_ordered = pts_cost_ordered# + cos_cost_ordered
...
class myAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        assigned_gt_inds, assigned_labels = self.cost(pts_pred, gt_pts, cls_pred,gt_labels)
        order_index = None
