...
model = dict(
    ...
    img_backbone=dict(
        ...
        frozen_stages=-1,
        norm_eval=True,
        init_cfg=dict(type='Pretrained', checkpoint='ckpts/vovnet99_ese_detectron2.pth', prefix='backbone.bottom_up')
    ),
    img_neck=dict(
        type='FPN',
        in_channels=[1024],
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'hdmap/maptr/nuscenes_infos_temporal_train.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             ann_file=data_root + 'hdmap/maptr/nuscenes_infos_temporal_val.pkl',
             map_ann_file=data_root + 'hdmap/maptr/nuscenes_map_anns_val.json',
