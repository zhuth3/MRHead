...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_dir=dict(type='PtsDirCosLoss', loss_weight=0.02),
        # loss_angle=dict(type='PtsAngleLoss', loss_weight=0.0)
        ),
    ...
    manifold_head=dict(
        ...
        assigner=dict(
            ...
            # cos_cost=dict(type='CosineCost', weight=5.0),
            pc_range=point_cloud_range),
        loss_cls=dict(
            type='FocalLoss',
            use_sigmoid=True,
    ...
    train_cfg=dict(
        pts=dict(
            ...
            #             type='myMatch',
            #             feature_dim = 20,
            #             layer_names = ['self', 'coss'] * 1,
            #             ),),
            )))

dataset_type = 'CustomNuScenesLocalMapDataset'
data_root = '/home/a/data3/nuscenes/v1.0-trainval/'
# data_root = '/home/a/data3/nuscenes/v1.0-mini/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'mini-batch/nuscenes_infos_temporal_train.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             ann_file=data_root + 'mini-batch/nuscenes_infos_temporal_val.pkl',
             map_ann_file=data_root + 'mini-batch/nuscenes_map_anns_val.json',
