...
We provide all the visualization scripts under `/path/to/MRHead/tools/maptr/`

## Visualize prediction

```shell
cd /path/to/MRHead/
export PYTHONPATH="/path/to/MRHead/"
...
```
**Notes**: 
- The video will be saved in `/path/to/MRHead/work_dirs/experiment/`